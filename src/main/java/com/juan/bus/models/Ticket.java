...
public class Ticket {
	...
	public String toString() {
		return "Ticket [id=" + id + ", seatNumber=" + seatNumber + ", cancellable=" + cancellable + ", journeyDate="
				+ journeyDate + ", tripSchedule=" + tripSchedule + ", passenger=" + passenger + ", hashCode()="
				+ hashCode() + ", getId()=" + getId() + ", getSeatNumber()=" + getSeatNumber() + ", getCancellable()="
				+ getCancellable() + ", getJourneyDate()=" + getJourneyDate() + ", getTripSchedule()="
				+ getTripSchedule() + ", getPassenger()=" + getPassenger() + ", getClass()=" + getClass()
